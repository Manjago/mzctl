...
class AldousBroderMazeGeneratorFactoryTest {
    ...
    void generateMaze(@NotNull MazeDim mazeDim, boolean drawAscii, boolean drawPng) throws IOException {
        ...
        mazeGeneratorFactory.create(MazeGeneratorFactory.Algo.ALDOUS_BRODER, mazeDim);
        ...
        if (drawPng) {
            new MazeImageVisualizer(maze).saveMazeImage(
                    String.format("target/aldous-broder-%s.png", mazeDim.display()));
        }
