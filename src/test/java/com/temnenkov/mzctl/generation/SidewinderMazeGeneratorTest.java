...
class SidewinderMazeGeneratorTest {
    @Test
    void generateMaze2d20to20AndShow() throws IOException {
        //given
        final Random random = new SecureRandom();
        final SidewinderMazeGenerator sidewinderMazeGenerator = new SidewinderMazeGenerator(MazeDim.of(20, 20), random);
        //when
        final Maze maze = sidewinderMazeGenerator.generateMaze();
        //then
        assertNotNull(maze);
    ...
    void generateMaze2d5to5AndShow() throws IOException {
        //given
        final Random random = new SecureRandom();
        final SidewinderMazeGenerator binaryTreeMazeGenerator = new SidewinderMazeGenerator(MazeDim.of(5, 5), random);
        //when
