...
class RandomizedKruskalMazeGeneratorTest {
    @Test
    void generateMaze2d20to20AndShow() throws IOException {
        //given
        final Random random = new SecureRandom();
        final RandomizedKruskalMazeGenerator randomizedKruskalMazeGenerator = new RandomizedKruskalMazeGenerator(MazeDim.of(20, 20), random);
        //when
    ...
    void generateMaze2d5to5AndShow() throws IOException {
        //given
        final Random random = new SecureRandom();
        final RandomizedKruskalMazeGenerator randomizedKruskalMazeGenerator = new RandomizedKruskalMazeGenerator(MazeDim.of(5, 5), random);
        //when
        final Maze maze = randomizedKruskalMazeGenerator.generateMaze();
        //then
        assertNotNull(maze);
