...
class MazeGenerationStatTest {
    ...
    Размерность: 2D
    Размер: 50x50 (или даже 100x100, если твоя реализация достаточно быстрая)
    ...
    - Размерность: 3D
    - Размер: 20x20x20 (или больше, если позволяет производительность)
    ...
    - Размерность: 2D
    - Размер: 10x50 или 50x10 (сильно вытянутый прямоугольник)
    ...
    */
    ...
    /*
    5a. Экстремально вытянутый лабиринт (не квадратный):
    - Размерность: 2D
    ...
    */
    ...
    /*
    5b. Совсем экстремально вытянутый лабиринт (не квадратный):
    - Размерность: 2D
    ...
    */
    ...
    /*
   6a. Средний четырехмерный лабиринт (для интереса):
    - Размерность: 4D
    - Размер: 10x10x10x10
    - Цель: Проверка того, как алгоритмы справляются с высокой размерностью. Полезно, если твои алгоритмы поддерживают произвольную размерность.
    */
