...
class WilsonMazeGeneratorFactoryTest {
    ...
    void generateMaze(@NotNull MazeDim mazeDim, boolean drawAscii, boolean drawPng) throws IOException {
        ...
        mazeGeneratorFactory.create(MazeGeneratorFactory.Algo.WILSON, mazeDim);
        ...
        if (drawPng) {
            new MazeImageVisualizer(maze).saveMazeImage(
                    String.format("target/wilson-%s.png", mazeDim.display()));
        }
